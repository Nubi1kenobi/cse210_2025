...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product product3 = new Product("productC", "C-789GHI", 20);
        ...
        orderA.CustomerSetup("Bryan Stauch","123 A Street", "Odessa", "TX", "79707", "USA");
        ...
        Console.Write($"Your Total Price is ${orderA.TotalCostOfOrder()}.\n\n");
        Console.Write("<Press Any Key>");
        Console.ReadKey();
        Console.Clear();
        Order orderB = new Order();
        orderB.CustomerSetup("Some Canadian","123 A Street", "Toronto", "Ontario", "M4C 1T1", "Canada");
        ...
        Console.Write($"Your Total Price is ${orderB.TotalCostOfOrder()}.\n\n");
        Console.Write("<Press Any Key>");
        Console.ReadKey();
        Console.Clear();
         Order orderC = new Order();
        orderC.CustomerSetup("Another Canadian","456 C Street", "Toronto", "Ontario", "M4C 1T3", "Canada");
